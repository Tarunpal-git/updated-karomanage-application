      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.card}>
          ...
          <ThemeScrollView contentContainerStyle={{ paddingBottom: 50 }}>
            ...
            <Field name="hs_percentage" label="Percentage*" rules={{ required: "Required" }} control={control} errors={errors} keyboardType="numeric" maxLength={2} />
            ...
            {(educationType === "Higher Secondary School" ||
              ...
              <>
                ...
                <Field name="hsc_percentage" label="Percentage*" rules={{ required: "Required" }} control={control} errors={errors} keyboardType="numeric" maxLength={2} />
            ...
            {(educationType === "Graduation" || educationType === "Post Graduation") && (
              <>
                ...
                <Field name="grad_percentage" label="Percentage*" rules={{ required: "Required" }} control={control} errors={errors} keyboardType="numeric" maxLength={2} />
            ...
            {educationType === "Post Graduation" && (
              <>
                ...
                <Field name="pg_percentage" label="Percentage*" rules={{ required: "Required" }} control={control} errors={errors} keyboardType="numeric" maxLength={2} />
