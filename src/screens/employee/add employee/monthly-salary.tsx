            ...
            <>
             ...
             <Text style={styles.text}>{salaryType || "Select Salary Type"}</Text>
                ...
                <View style={styles.dropdown}>
                  ...
                  <View style={styles.salaryRow}>
                    <TouchableOpacity style={{flex:1}} onPress={()=>{
                      setSalaryType("Fixed Salary Per Month");
                      setOpenSalary(false); 
                      setSalaryTypeErr("");
                  ...
                  <View style={styles.salaryRow}>
                    <TouchableOpacity style={{flex:1}} onPress={()=>{
                      setSalaryType("Percentage Salary");
                      setOpenSalary(false); 
                      setSalaryTypeErr("");
                      // Fields will be cleared by useEffect
                    }}>
                  ...
                  <View style={styles.salaryRow}>
                    <TouchableOpacity style={{flex:1}} onPress={()=>{
                      setSalaryType("Fixed and Percentage");
                      setOpenSalary(false); 
                      setSalaryTypeErr("");
                      // Fields will be cleared by useEffect
                    }}>
              ...
              {salaryType==="Percentage Salary" && (
                <>
                  <ScalableText style={styles.label} fontFamily="Medium">Percentage Salary*</ScalableText>
                  <TextInput style={[styles.input,fixedSalaryErr&&styles.inputError]} placeholder="Enter % salary"
                    keyboardType="numeric" value={fixedSalary} maxLength={2}
                    onChangeText={(v)=>{if(/^[0-9]*$/.test(v) && v.length <= 2) setFixedSalary(v);setFixedSalaryErr("");}}/>
                  {fixedSalaryErr && <Text style={styles.errorMsg}>{fixedSalaryErr}</Text>}
     ...
     <TouchableOpacity key={i} onPress={() => {
       ...
       <Text style={styles.option}>{b.batchName}</Text>
              ...
              {salaryType==="Fixed and Percentage" && (
                <>
                  <ScalableText style={styles.label} fontFamily="Medium">Fixed Salary Amount*</ScalableText>
                  <TextInput style={[styles.input,fixedSalaryErr&&styles.inputError]} keyboardType="numeric"
                    placeholder="₹ fixed salary" value={fixedSalary}
                    onChangeText={(v)=>{if(/^[0-9]*$/.test(v)) setFixedSalary(v);setFixedSalaryErr("");}}/>
                  {fixedSalaryErr && <Text style={styles.errorMsg}>{fixedSalaryErr}</Text>}

                  <ScalableText style={styles.label} fontFamily="Medium">Percentage (%)*</ScalableText>
                  <TextInput style={[styles.input,salaryError&&styles.inputError]} keyboardType="numeric"
                    placeholder="% percentage" value={salaryAmount} maxLength={2}
                    onChangeText={(v)=>{if(/^[0-9]*$/.test(v) && v.length <= 2) setSalaryAmount(v);setSalaryError("");}}/>
