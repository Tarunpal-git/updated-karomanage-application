...
interface EmployeeNotificationItemCard {
  notification: TBirthdays;
  isOpen: boolean;
  onToggle: () => void;
}

const EmployeeNotificationItemCard: FC<EmployeeNotificationItemCard> = ({
  notification,
  isOpen,
  onToggle,
}) => {
    ...
    <View>
      ...
      >
        ...
        <Flex flex={1}>
          <ScalableText
            ...
            numberOfLines={1}
          >
            {`${notification.employeeFirstname} ${notification.employeeLastname}`}
          </ScalableText>
        </Flex>
      ...
      <Collapsible style={styles.collapsedContainer} collapsed={isOpen}>
        ...
        <Flex justify="space-between" my={8}>
          ...
          <ScalableText fontFamily="Regular" style={styles.content}>
            {notification.employeePhoneNumber}
          </ScalableText>
        </Flex>
        <Flex justify="space-between" my={8}>
          <ScalableText fontFamily="SemiBold" style={styles.heading}>
...
export default memo(EmployeeNotificationItemCard);
