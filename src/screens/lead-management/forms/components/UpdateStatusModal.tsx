...
import { useUpdateFormTemplateMutation } from "../../../../apis/hooks/lead-management/mutation/useUpdateFormTemplate.mutation";
...
const UpdateStatusModal: FC<IUpdateStatusModal> = ({
  ...
  const { mutateAsync, isPending } = useUpdateFormTemplateMutation();
