...
interface IOverduePaymentTable {
  forecast: TPaymentForecast[];
}

const OverduePaymentTable: FC<IOverduePaymentTable> = ({ forecast }) => {
  return (
                        ...
                        <Col>
                          ...
                          >
                            <ScalableText
                              ...
                              fontFamily="Regular"
                            >
                              {payment.Details?.duePayment?.toLocaleString()}
                            </ScalableText>
                          </Flex>
                        </Col>
                        <Col>
                        ...
                        <Col>
                          ...
                          >
                            <ScalableText
                              ...
                              fontFamily="Regular"
                            >
                              {payment.Details.nextpaymentDate}
                            </ScalableText>
                          </Flex>
                        </Col>
                      </Row>
...
export default memo(OverduePaymentTable);
