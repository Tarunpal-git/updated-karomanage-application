...
//   },
// });
import { StyleSheet, View, ViewStyle, Dimensions, TouchableOpacity } from "react-native";
import React, { FC, memo, useRef, useState } from "react";
import SelectDropdown from "react-native-select-dropdown";
      ...
      render={({ field: { onChange }, fieldState: { error } }) => {
        ...
        <View style={{ flex: 1 }}>
          <SelectDropdown
            ...
            renderButton={(selectedItem) => {
              // Use form value instead of dropdown's selectedItem to ensure proper clearing
              const displayValue = value?.value ? value : null;
              const displayText = displayValue?.label || selectedItem?.label || label;
              const hasValue = displayValue?.value && displayValue?.label;
              return (
                <View
                  style={{
                    ...styles.dropdownButtonStyle,
                ...
                >
                  <ScalableText
                    ...
                    style={{
                      ...styles.dropdownButtonTxtStyle,
                      color: hasValue ? COLORS.black : "#717171",
                      ...(disabled && styles.disabledText),
                    }}
                    numberOfLines={1}
                  >
